...
| C++ test   | See tests/cpp_roundtrip/CMakeLists.txt — build and run after generating into generated/ dir  |
...
- The C++ roundtrip test in `tests/cpp_roundtrip/` compiles and runs the generated C++ to prove bitpacking correctness
